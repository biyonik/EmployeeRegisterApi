...
const defaultImageSrc = '/img/employee.png';
    ...
    return (
        <React.Fragment>
            ...
            <form autoComplete={"off"} noValidate onSubmit={handleFormSubmit}>
                <div className="card">
                    <img src={values.imageSrc} alt="" className="card-img-top"/>
                    <div className="card-body">
                        ...
                        <div className="form-group">
                            <input type="text" className={"form-control "+applyErrorClass('occupation')} placeholder="Occupation" name="occupation"
